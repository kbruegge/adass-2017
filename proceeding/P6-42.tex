...
\articlefiguretwo{P6-42_f3.eps}{P6-42_f4.eps}{fig:image}{\emph{Left:} A typical image as recorded by an IACT camera.
\emph{Right:} Distribution of trigger multiplicities in the simulated data.}
...
\articlefiguretwo{P6-42_f5.eps}{P6-42_f6.eps}{fig:image}{\emph{Left:} A typical image as recorded by an IACT camera.
\emph{Right:} Distribution of trigger multiplicities in the simulated data.}

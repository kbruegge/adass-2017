...
\author{Kai Br\"ugge$^1$, Alexey Egorov$^2$, Katharina Morik$^2$ and Wolfgang Rhode$^2$}
\affil{$^1$TU Dortmund, Dortmund, Germany; \email{kai.bruegge@tu-dortmund.de}}
\affil{$^2$TU Dortmund, Dortmund, Germany; \email{firstname.lastname@tu-dortmund.de}}


% This section is for ADS Processing.  There must be one line per author.
\paperauthor{Kai~Br\"ugge}{kai.bruegge@tu-dortmund.de}{}{TU Dortmund}{Experimental Physics 5}{Dortmund}{NRW}{44227}{Germany}
...
\paperauthor{Wolfgang~Rhode}{wolfgang.rhode@tu-dortmund.de}{}{TU Dortmund}{Experimental Physics 5}{Dortmund}{NRW}{44227}{Germany}
...
% The official CTA requirements for the real time analysis define a maximum allowed delay of 30 seconds between input of the data
% and the output of the result.

\articlefiguretwo{P6-42_f1.eps}{P6-42_f7.eps}{fig:image}{\emph{Left:} A typical image as recorded by an IACT camera.
Entry windows for pixels on IACT cameras are typically hexagonal.
\emph{Right:} An image of accumulated simulated gamma-ray events from an astrophysical source as seen by this analysis.}
...
\articlefiguretwo{P6-42_f5.eps}{P6-42_f6.eps}{fig:machine-learning-perf}{\emph{Left:} Performance of background suppression for the
different telescope types. The small size telescope (SST), the mid size telescope (MST) and the large size telescope (LST).
\emph{Right:} Improved background suppression of a combined predictor when averaring the predictions for all single telescope in
a CTA event.}
...
TODO: show flink results in some nice way. Maybe even rate vs time or so. Maybe redo all tests because of changes from streams to jayct? dont know yet.
